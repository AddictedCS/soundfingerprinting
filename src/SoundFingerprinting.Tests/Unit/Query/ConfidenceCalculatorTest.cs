namespace SoundFingerprinting.Tests.Unit.Query
{
    ...
    public class ConfidenceCalculatorTest
    {
        ...
        public void ShouldCalculateConfidence1()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(0d, 120d, 10d, 30d, 20d, 20d, 20d);
        ...
        public void ShouldCalculateConfidence2()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(50d, 120d, 0d, 30d, 30d, 30d, 30d);
        ...
        public void ShouldCalculateConfidence3()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(110d, 120d, 0, 30d, 10d, 10d, 10d);
        ...
        public void ShouldCalculateConfidence4()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(50d, 10d, 50d, 120d, 10d, 10d, 10d);
        ...
        public void ShouldCalculateConfidence5()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(49d, 10d, 50d, 120d, 10d, 10d, 10d);
        ...
        public void ShouldCalculateConfidence6()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(0d, 10d, 50d, 120d, 10d, 10d, 10d);
        ...
        public void ShouldCalculateConfidence7()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(0d, 10d, 115d, 120d, 5d, 5d, 5d);
        ...
        public void ShouldCalculateConfidence()
        {
            ...
            double confidence = confidenceCalculator.CalculateConfidence(5d, 10d, 0d, 120d, 5d, 5d, 5d);
