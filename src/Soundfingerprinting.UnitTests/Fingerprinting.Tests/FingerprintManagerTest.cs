...
namespace Soundfingerprinting.UnitTests.Fingerprinting.Tests
{
    ...
    public class FingerprintManagerTest : BaseTest
    {
        ...
        /// <summary>
        ///   Old method for extracting top-wavelets
        /// </summary>
        /// <param name = "frames">Frames to be extracted</param>
        /// <param name = "topWavelets">Number of top wavelets</param>
        /// <returns>Boolean array as a signature</returns>
        public bool[] ExtractTopWaveletsOld(float[][] frames, int topWavelets)
        {
        ...
        /// <summary>
        ///   Extract Top Wavelets using null parameter
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof (ArgumentNullException))]
        public void ExtractTopWaveletsNullTest()
        {
            string name = MethodBase.GetCurrentMethod().Name;
            if (Bswitch.Enabled)
                Trace.WriteLine("#" + name + " : test started at : " + DateTime.Now);

            _fingerManager.ExtractTopWavelets(null);
        ...
        /// <summary>
        ///   Extracting Top Wavelets by passing null row
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof (ArgumentNullException))]
        public void ExtractTopWaveletsRowNullTest()
        {
            string name = MethodBase.GetCurrentMethod().Name;
            if (Bswitch.Enabled)
                Trace.WriteLine("#" + name + " : test started at : " + DateTime.Now);
            ...
            _fingerManager.ExtractTopWavelets(frames);
        ...
        public void ExtractTopWaveletesText()
        {
            ...
            bool[] actual = _fingerManager.ExtractTopWavelets(frames);
            bool[] expected = ExtractTopWaveletsOld(frames, _fingerManager.TopWavelets);
        ...
        /// <summary>
        ///   Extract Top Wavelets by passing an argument less than 0
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof (ArgumentException))]
        public void ExtractTopWaveletsLessThanZeroArgumentTest()
        {
            string name = MethodBase.GetCurrentMethod().Name;
            if (Bswitch.Enabled)
                Trace.WriteLine("#" + name + " : test started at : " + DateTime.Now);
        ...
        /// <summary>
        ///   Compute logarithmical spaced bins by passing null
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof (ArgumentNullException))]
        public void LogBinNullParameterTest()
        {
            string name = MethodBase.GetCurrentMethod().Name;
            if (Bswitch.Enabled)
                Trace.WriteLine("#" + name + " : test started at : " + DateTime.Now);

            _fingerManager.ExtractLogBins(null);
