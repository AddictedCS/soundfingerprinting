    ...
    public class PendingResultEntry
    {
        ...
        public PendingResultEntry Wait(double length)
        {
            ...
            var resultEntry = new ResultEntry(Entry.Track, Entry.Confidence, Entry.Score,
                Entry.MatchedAt, newQueryLength, Entry.QueryMatchStartsAt, Entry.TrackCoverageWithPermittedGapsLength,
                Entry.DiscreteTrackCoverageLength, Entry.TrackMatchStartsAt, Entry.TrackStartsAt);
