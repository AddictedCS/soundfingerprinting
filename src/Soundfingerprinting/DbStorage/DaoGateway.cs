...
namespace Soundfingerprinting.DbStorage
{
    ...
    public class DaoGateway
    {
        ...
        private const string FIELD_ALBUM_ID = "Id";
        ...
        {
            _dbProvider = SqlClientFactory.Instance; /*the only field that needs to be changed in case of a DB switch*/
            _connString = connectionString;
            _spBuilder = new DaoStoredProcedureBuilder(_dbProvider);
        }
        ...
        private DbConnection GetConnection()
        {
            ...
            throw new Exception("Cannot create connection of db provider type " + _dbProvider.GetType());
        }
        ...
        private readonly DaoStoredProcedureBuilder _spBuilder;
        ...
        private static Album FillAlbum(DbDataReader sqlDr)
        {
            ...
            {
                a = new Album((Int32) sqlDr[FIELD_ALBUM_ID],
        ...
        private static List<Album> FillAlbumList(DbDataReader sqlDr)
        {
            ...
            if (sqlDr.Read()) //positioning the cursor
            {
                ...
                do
                {
                    Album a = new Album((Int32) sqlDr[FIELD_ALBUM_ID],
                        (String) sqlDr[FIELD_ALBUM_NAME],
                        (int) sqlDr[FIELD_ALBUM_RELEASE_YEAR]);
        ...
        public void InsertFingerprint(Fingerprint fingerprint)
        {
            ...
            DbCommand cmd = _spBuilder.GetInsertFingerprintCommand(fingerprint, GetConnection()); /*Get Command*/
            try
            {
        ...
        public void InsertFingerprint(IEnumerable<Fingerprint> collection)
        {
            ...
            using (DbConnection con = GetConnection())
            {
                try
                {
                    ...
                    {
                        DbCommand cmd = _spBuilder.GetInsertFingerprintCommand(f, con); /*Pass the same connection object for the second query*/
        ...
        public void InsertTrack(Track track)
        {
            ...
            DbCommand cmd = _spBuilder.GetInsertTrackCommand(track, GetConnection()); /*Get Command*/
            try
            {
                cmd.Connection.Open(); /*Open Connection*/
        ...
        public void InsertTrack(IEnumerable<Track> collection)
        {
            ...
            using (DbConnection con = GetConnection())
            {
                try
                {
                    ...
                    {
                        DbCommand cmd = _spBuilder.GetInsertTrackCommand(t, con); /*Pass the same connection object for the second query*/
        ...
        public void InsertAlbum(Album album)
        {
            ...
            DbCommand cmd = _spBuilder.GetInsertAlbumCommand(album, GetConnection()); /*Get Command*/
            try
            {
                cmd.Connection.Open(); /*Open Connection*/
        ...
        public virtual void InsertAlbum(IEnumerable<Album> collection)
        {
            ...
            using (DbConnection con = GetConnection()) /*Get Connection*/
            {
                try
                {
                    ...
                    {
                        DbCommand cmd = _spBuilder.GetInsertAlbumCommand(a, con); /*Pass the same connection object for the second query*/
        ...
        public void InsertHashBin(HashBin hashBin)
        {
            ...
            if (hashBin is HashBinNeuralHasher)
                cmd = _spBuilder.GetInsertHashBinNeuralHasherCommand(hashBin as HashBinNeuralHasher, GetConnection()); /*Get Command*/
            else if (hashBin is HashBinMinHash)
                cmd = _spBuilder.GetInsertHashBinMinHashCommand(hashBin as HashBinMinHash, GetConnection()); /*Get Command*/
            else
                ...
                using (DbConnection con = GetConnection())
                {
                    try
                    {
                        ...
                        foreach (T h in collection)
                        {
                            ...
                            if (hash != null)
                            {
                                DbCommand cmd = _spBuilder.GetInsertHashBinMinHashCommand(hash, con); /*Pass the same connection object for the second query*/
                ...
                using (DbConnection con = GetConnection())
                {
                    try
                    {
                        ...
                        foreach (T h in collection)
                        {
                            ...
                            if (hash != null)
                            {
                                DbCommand cmd = _spBuilder.GetInsertHashBinNeuralHasherCommand(hash, con); /*Pass the same connection object for the second query*/
                                hash.Id = (int) cmd.ExecuteScalar();
                            }
                        }
                    }
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadDuplicatedTracks(GetConnection());
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadFingerprintsCommand(GetConnection());
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadFingerprintByTrackIdCommand(trackId, numberOfFingerprintsToRead, GetConnection());
            List<Fingerprint> listOfFingerprints = null;
            DbDataReader reader = null;
            try
            {
        ...
        public Dictionary<Int32, List<Fingerprint>> ReadFingerprintsByMultipleTrackId(List<Track> tracks, int numberOfFingerprintsToRead)
        {
            ...
            try
            {
                ...
                {
                    DbCommand sqlCmd = _spBuilder.GetReadFingerprintByTrackIdCommand(track.Id, numberOfFingerprintsToRead, sqlConnection);
                    List<Fingerprint> listOfFingerprints = null;
                    reader = sqlCmd.ExecuteReader();
                    if (reader != null)
                    {
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadFingerprintByIdCommand(id, GetConnection());
        ...
        public List<Fingerprint> ReadFingerprintById(IEnumerable<Int32> ids)
        {
            ...
            try
            {
                ...
                {
                    DbCommand sqlCmd = _spBuilder.GetReadFingerprintByIdCommand(id, connection);
                    reader = sqlCmd.ExecuteReader();
                    if (reader != null)
                    {
                        if (reader.Read())
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadTracksCommand(GetConnection());
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadTracksByIdCommand(id, GetConnection());
            Track retVal = null;
            DbDataReader reader = null;
            try
            {
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadTrackByArtistAndTitleNameCommand(artist, title, GetConnection());
            Track retVal = null;
            DbDataReader reader = null;
            try
            {
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadAlbumsCommand(GetConnection());
        ...
        public Album ReadUnknownAlbum()
        {
            ...
            DbCommand sqlCmd = _spBuilder.GetReadUnknownAlbum(unknownName, GetConnection());
            Album album = null;
            DbDataReader reader = null;
            try
            {
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadUnknownAlbum(name, GetConnection());
            Album album = null;
            DbDataReader reader = null;
            try
            {
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadAlbumsByIdCommand(id, GetConnection());
            Album retVal = null;
            DbDataReader reader = null;
            try
            {
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadTrackByFingerprintCommand(id, GetConnection());
            List<Track> listOfTracks = null;
            DbDataReader reader = null;
            try
            {
        ...
        {
            DbCommand sqlCmd = _spBuilder.GetReadTrackIdByHashBinAndHashTableNeuralHasher(hashBin, hashTable, GetConnection());
        ...
        public Dictionary<Int32, int> ReadTrackIdCandidatesByHashBinAndHashTableNeuralHasher(long[] hashBins, int[] hashTables)
        {
            ...
            try
            {
                ...
                {
                    DbCommand sqlCmd = _spBuilder.GetReadTrackIdByHashBinAndHashTableNeuralHasher(hashBins[i], hashTables[i], connection);
                    reader = sqlCmd.ExecuteReader();
                    if (reader != null)
                    {
                        if (reader.Read())
        ...
        public Dictionary<Int32, List<HashBinMinHash>> ReadFingerprintsByHashBucketAndHashTableLSH(long[] hashBucket, int[] hashTables)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < hashTables.Length; i++)
                {
                    DbCommand sqlCmd = _spBuilder.GetReadHashBinsByHashBucketAndHashTableLSH(hashBucket[i], hashTables[i], connection);
                    reader = sqlCmd.ExecuteReader();
                    if (reader != null)
                    {
                        if (reader.Read())
        ...
        public Dictionary<Int32, List<HashBinMinHash>> ReadFingerprintsByHashBucketLSH(long[] hashBucket)
        {
            ...
            try
            {
                ...
                {
                    DbCommand sqlCmd = _spBuilder.GetReadHashBinsByHashBinsMinHashLSH(t, connection);
                    reader = sqlCmd.ExecuteReader();
                    if (reader != null)
                    {
                        if (reader.Read())
        ...
        public Dictionary<Int32, Tuple<Int32, int>> ReadFingerprintsByHashBucketLSH(long[] hashBucket, int threshold)
        {
            ...
            try
            {
                DbCommand sqlCmd = _spBuilder.GetReadFingerprintsByThresholdAndHashBinsMinHash(hashbins, delimiter, threshold, connection);
                connection.Open();
                reader = sqlCmd.ExecuteReader();
                if (reader != null)
                {
        ...
        {
            DbCommand cmd = _spBuilder.GetDeleteTrackCommand(trackId, GetConnection());
            int retVal = 0;
            try
            {
                cmd.Connection.Open();
        ...
        public int DeleteTrack(IEnumerable<Int32> collection)
        {
            ...
            using (DbConnection con = GetConnection())
            {
                ...
                {
                    con.Open();
                    mRows = collection.Select(id => _spBuilder.GetDeleteTrackCommand(id, con)).Select(cmd => cmd.ExecuteNonQuery()).Sum();
                }
                finally
                {
                    con.Close();
        ...
        public int DeleteTrack(IEnumerable<Track> collection)
        {
            ...
            using (DbConnection con = GetConnection())
            {
                try
                {
                    ...
                    {
                        DbCommand cmd = _spBuilder.GetDeleteTrackCommand(track.Id, con);
