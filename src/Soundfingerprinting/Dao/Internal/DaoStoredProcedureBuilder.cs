namespace Soundfingerprinting.Dao.Internal
{
    ...
    internal class DaoStoredProcedureBuilder
    {
        private const int CommandTimeout = 60 * 10; /*600 sec*/
        ...
        private const string SP_READ_HASHBINS_BY_HASHBIN_HASHTABLE_MINHASH =
            "sp_ReadHashBinsByHashBinAndHashTableMinHash";

        private const string SP_READ_FINGERPRINT_CANDIDATES_BY_HASHBIN_HASHTABLE_MINHASH =
            "sp_ReadFingerprintCandidatesByHashBinHashTableMinHash";
        ...
        private const string SP_READ_ALL_FINGERPRINTID_BYHASHTABLES_HASHBUCKETS =
            "sp_HashBinReadAllByHashBucketHashTable";
        ...
        /// </summary>
        /// <param name = "nameOfStoredProcedure">Name of the stored procedure</param>
        /// <returns>Command to be executed</returns>
        /// <param name = "connection">Connection object to the database</param>
        private DbCommand GetStoredProcedureCommand(string nameOfStoredProcedure, DbConnection connection)
        {
            if (string.IsNullOrEmpty(nameOfStoredProcedure))
            {
                throw new ArgumentException("cmdTest parameter is null or empty");
            }
